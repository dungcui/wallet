...
class ZecMonitor extends Monitor {
  constructor({
    zecSleepTime, zecStartBlockHeight, zecMinimumConfirmation, zecRpc,
    db, block, token, zecInterpreter, funding, withdrawal, failedApi, limit, address,
    zecMaximumInput,
  }) {
    super({
      db,
      ...
      block,
      token,
      interpreter: zecInterpreter,
      funding,
      withdrawal,
      failedApi,
      limit,
      address,
      startBlockHeight: zecStartBlockHeight,
      minimumConfirmation: zecMinimumConfirmation,
      sleepTime: zecSleepTime,
    });
