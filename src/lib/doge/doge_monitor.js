...
class DogeMonitor extends Monitor {
  constructor({
    dogeSleepTime, dogeStartBlockHeight, dogeMinimumConfirmation, dogeRpc,
    db, block, token, dogeInterpreter, funding, withdrawal,failedApi, limit, address,
    dogeMaximumInput,
  }) {
    super({
      db,
      ...
      block,
      token,
      interpreter: dogeInterpreter,
      funding,
      withdrawal,
      failedApi,
      limit,
      address,
      startBlockHeight: dogeStartBlockHeight,
      minimumConfirmation: dogeMinimumConfirmation,
      sleepTime: dogeSleepTime,
    });
